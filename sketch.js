...
function mouseReleased()
{
  ...
  if(waterballoon.body.position.x>=950 && waterballoon.body.position.x<=1150 && waterballoon.body.position.y>=550 && waterballoon.body.position.y<= 600){
    console.log("hhhhhhhhhhhhhhhhhhhhhhhh");
       Score=Score+40;
  }

  if(waterballoon.body.position.x>=750 && waterballoon.body.position.x<=950 && waterballoon.body.position.y>=550 && waterballoon.body.position.y<= 600){
    console.log("touching line");
    Score=Score+30;
}

if(waterballoon.body.position.x>=550 && waterballoon.body.position.x<=750 && waterballoon.body.position.y>=550 && waterballoon.body.position.y<= 600){
  console.log("hhhhhhhhhhhhhhhhhhhhhhhh");
  Score=Score+20;
}
//if(waterballoon.body.position.x=== redLine.x && waterballoon.body.position.y>=550 && waterballoon.body.position.y<= 600){
  if(waterballoon.body.position.x>=450 && waterballoon.body.position.x<=550 && waterballoon.body.position.y>=550 && waterballoon.body.position.y<= 600){
  console.log("hhhhhhhhhhhhhhhhhhhhhhhh");
  Score=Score+10;
}
}
